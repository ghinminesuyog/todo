...
let AppComponent = class AppComponent {
    ...
    getCollections() {
        this.appService.getCollections().subscribe((collections) => {
    ...
    saveAllCollections(collection) {
        this.appService.saveCollections(this.collections).subscribe((response) => {
            // this.getCollections();
        });
    }
};
...
class Collection {
    ...
    markAllAsTodo() {
        this.completedTasks.forEach((todo) => {
            todo.isDone = false;
...
/* harmony import */ var _side_bar_side_bar_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./side-bar/side-bar.component */ "./src/app/side-bar/side-bar.component.ts");
...
let AppService = class AppService {
    ...
    addCollection(title) {
        const collection = new _app_model__WEBPACK_IMPORTED_MODULE_3__["Collection"](title);
    ...
    readFromLocalStorage() {
        try {
            ...
            for (const collectionObject of collections) {
                const collection = new _app_model__WEBPACK_IMPORTED_MODULE_3__["Collection"](collectionObject.title);
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], SideBarComponent.prototype, "selectedCollection", void 0);
SideBarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./side-bar.component.scss */ "./src/app/side-bar/side-bar.component.scss")).default]
    })
], SideBarComponent);
...
let TodoComponent = class TodoComponent {
    ...
    changeTaskTitle(collectionId, taskId) {
        this.saveCollectionChanges.emit(this.collection);
    }
    ...
    deleteCollection() {
        this.appService.deleteCollection(this.collection.id).subscribe((response) => {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TodoComponent.prototype, "collection", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], TodoComponent.prototype, "saveCollectionChanges", void 0);
...
module.exports = __webpack_require__(/*! /Users/suyog/todo/src/main.ts */"./src/main.ts");
